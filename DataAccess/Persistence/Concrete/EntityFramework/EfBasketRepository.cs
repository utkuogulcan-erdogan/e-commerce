...
{
    public class EfBasketRepository : EfEntityRepositoryBase<Basket, MyShopContext>, IBasketRepository
    {
        public EfBasketRepository(MyShopContext context) : base(context)
        {
        }
